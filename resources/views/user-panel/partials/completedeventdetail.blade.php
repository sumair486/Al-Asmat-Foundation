...
@section("title","Completed Event | Detail_Page")
			...
			<div class="row">
				<div class="col-md-12">
					<div class="header-content">
						<div class="col-md-8">
							<h1>Completed Events Detail</h1>
							<ul class="breadcrumb">
								<li><a href="home">Home</a></li>
								<li><a href="completedevent">Completed Events</a></li>
								<li><a href="#">Completed Events Detail</a></li>
							</ul>
						</div>
					</div>
				...
				<main id="main" class="col-md-9">
					...
					<div class="article causes-details">
						...
						<div class="clearfix">
							...
							<a href="#" class="primary-button causes-donate">Completed</a>
						</div>
						<!-- /causes progress -->
