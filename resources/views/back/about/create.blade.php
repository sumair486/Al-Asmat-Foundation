...
<form  method="post" action="{{ route('about.store') }}" enctype="multipart/form-data">
    ...
    <div class="row mb-4">
      <div class="col">
        <div class="form-outline">
          ...
          <input placeholder="Enter Here..." type="text" name="title" id="form6Example1" class="form-control" />
        </div>
      </div>
      <div class="col">
        <div class="form-outline">
          ...
          <input placeholder="Enter Here..." type="text" name="heading" id="form6Example2" class="form-control" />
        </div>
      </div>
    </div>
    ...
    <div class="row form-outline mb-4">
        ...
        <div class="col-md-6">
            ...
            <textarea placeholder="Enter Here..." type="text" name="about_text" id="form6Example3" class="form-control"></textarea>
        </div>
